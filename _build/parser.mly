...
func :
  | VAR func                                                  { Fun (Nom $1,$2) }
  | UNDERSCORE func                                           { Fun (None,$2) }
  | VAR EQ expression                                         { Fun (Nom $1,$3) }
  | UNDERSCORE EQ expression                                  { Fun (None,$3) }
...
declaration : 
  | LET VAR func IN expression                                { Let (Nom $2,false,$3,$5) }
  | LET REC VAR func IN expression                            { Let (Nom $3,true,$4,$6) }
